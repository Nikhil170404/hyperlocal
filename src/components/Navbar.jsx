// src/components/Navbar.jsx - Modern Version
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex justify-between items-center h-16">
            ...
            <Link to="/" className="flex items-center space-x-2 group">
              <div className="bg-gradient-to-br from-green-600 to-emerald-700 text-white p-2 rounded-xl shadow-lg group-hover:shadow-xl transition-all duration-300 transform group-hover:scale-105">
              ...
              {currentUser ? (
                <>
                  ...
                  >
                    ...
                    {/* Cart Badge - Replace 0 with actual cart count */}
                  ...
                  <div className="relative ml-3">
                    ...
                    >
                      <div className="w-8 h-8 rounded-full bg-gradient-to-br from-green-600 to-emerald-700 flex items-center justify-center text-white font-bold text-sm">
                    ...
                    {isMenuOpen && (
                      <>
                        ...
                        <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-2xl py-2 z-20 border border-gray-100">
                          ...
                          <Link
                            to="/profile"
                            className="flex items-center gap-3 px-4 py-2.5 text-gray-700 hover:bg-green-50 hover:text-green-600 transition-colors"
                            onClick={() => setIsMenuOpen(false)}
                          >
                ...
                <>
                  ...
                  <Link
                    to="/register"
                    className="px-6 py-2.5 bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-lg font-semibold hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-200"
                  >
                    Get Started
                  </Link>
                </>
            ...
            <div className="md:hidden border-t border-gray-100 py-4 animate-fade-in">
              {currentUser ? (
                ...
                <div className="space-y-2">
                  ...
                  <Link
                    to="/register"
                    className="block px-4 py-3 bg-gradient-to-r from-green-600 to-emerald-600 text-white text-center font-semibold rounded-lg hover:shadow-lg transition-all"
                    onClick={() => setIsMenuOpen(false)}
                  >
                    Get Started
                  </Link>
